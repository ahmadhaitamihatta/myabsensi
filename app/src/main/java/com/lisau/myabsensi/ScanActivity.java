...
//        Log.v("TAG 2", rawResult.getBarcodeFormat().toString());
        ...
        //3080686f-c5ad-42a6-af56-22eea8d342bc
        ...
        String nim = tokens.nextToken(); //12345
        ...
        if (cekSimpan) {
            ...
            absen(uid,nim,nama,tanggal,jam);
    ...
    //Prosedure simpan data di cloud
    private void absen(String uid, String nim, String nama, String tanggal, String jam) {
        ...
        //defining the call
        Call<Result> call = service.simpanDataCloud(Apiurl.API_KEY, uid, nim, nama, tanggal, jam,"1", "0");
